...
(function ($) {
    ...
    /**
     * Handles click event on load more activity button.
     * Loads more activity items via AJAX.
     */
    ...
    /**
     * Checks if the element with class 'load-more-activity' exists on the page.
     * This is used to determine if more activities should be loaded when the 
     * user scrolls.
     */
    ...
    /**
    * Handles click event on "show activity details" button.
    * Gets the post ID from the data attribute and saves it to a variable.
    */
    ...
    /**
     * Handles click event on tabs other than the subscriptions tab.
     * Gets the data ID from the active tab anchor element.
    */
    ...
    /**
     * Handles click event on the "Go Back" button.
     * Fades the list view back in.
     */
    ...
    /**
     * Handles click event on markup elements.
     * Removes 'my-class' class from all elements with 'markup' class.
    */
    ...
    /**
     * Handles click event on ellipsis icon.
     * Toggles 'is_active' class on parent '.buttons-holder' element.
    */
     ...
     * Checks if the clicked element is NOT a ellipsis icon, 
     * and executes code if it isn't.
     */
...
/**
 * Removes the ACF block attributes with the given element ID to remove.
 * Updates the block attributes by removing any that contain the element ID.
 * 
 * @param {Object} blockAttributes - The block attributes object
 * @param {string} clientId - The block client ID
 * @param {string} elIDRemove - The element ID to remove 
 */
...
/**
 * Removes the gallery tag with the given ID from the block attributes.
 * Iterates through all gallery items and removes the one matching the ID.
 */
...
/**
 * Removes the table tag with the given ID from the block attributes.
 * Iterates through table attribute arrays and removes the one matching the ID.
*/
...
/**
 * Returns the default comments limit.
 */
...
/**
 * Calculates a relative "time ago" string for the given time.
 */
...
/**
 * Returns the current timestamp in seconds with the timezone offset added.
 * 
 * Gets the current timestamp in milliseconds, converts to seconds, and adds the timezone offset 
 * in hours multiplied by 3600 seconds. This accounts for the configured timezone when getting the timestamp.
 */
...
/**
 * Translates a time string to the localized format.
 *
 * @param {string} time - The time string to translate.
...
/**
 * Gets the current user's ID from WordPress.
 * 
 * Parses the id property from the currentUserData global variable
 * containing info on the current user.
 * 
...
/**
 * Gets information about the current logged in user by their user ID.
 *
 * This would retrieve the user object for the current user from the WordPress database.
...
/**
 * Scrolls the board container to a given vertical position.
 * 
 * @param {number} topOfText - The vertical position in pixels to scroll to.
 */
...
/**
 * Removes the floating comment icon element from the DOM.
 * 
 * The floating comment icon is displayed over the content when 
 * the user is logged in. This function finds the element by 
 * class name and removes it from the DOM.
 */
...
/**
 * Translates the given string by replacing placeholders with values.
 * 
...
/**
 * Removes any script tags and their content from the provided string.
 *
 * @param {string} newText - The string to sanitize.
...
/**
 * Removes any link tags from the given string.
 * 
 * @param {string} editedValue - The string to remove links from.
 */
...
/**
 * Filters the given text to convert URLs to links and handle other formatting.
 * 
 * @param {string} newText - The text to filter.
...
/**
 * Validates the given comment reply text.
 *
 * @param {string} newText - The comment reply text to validate.
...
/**
 * Converts a user role string to a different format.
 *
 * @param {string} myStr - The user role string to convert.
 * @returns {string} The converted user role string.
 */
...
/**
 * Closes the multicollab sidebar.
 */
...
/**
 * Checks if the post being edited is a new post.
 *
 * @returns {boolean} True if the post is new, false otherwise.
 */
...
/**
 * Appends an info board div to the page.
 * Likely adds a div for displaying status information.
 */
...
/**
 * Gets the post status label to display in the info board.
 */
...
/**
 * Shows the info board div if there are new comments.
 */
...
/**
 * Appends a new notice board div to the page.
 */
 ...
 * 
 * @returns {string} The HTML content of the current selection.
 */
...
/**
 * Removes all notices from the core/notices data store.
 *
 * Gets an array of all notices from the core/notices data store
 * and removes them.
 */
...
/**
 * Code to show the info board when there are new comments, 
 * if the showinfoboard option is enabled.
 * Checks if the showinfoboard option is enabled, and if so,
 * calls the showInfoBoardonNewComments() function.
 */
...
/**
 * Creates a new div element to serve as a parent node, likely for appending comment nodes.
 */
...
/**
 * Sets a browser cookie with the given name, value and expiration time in minutes.
 * 
 ...
 * @returns {string} The cookie value if found, otherwise empty string.
 */
 ...
 * Gets the value of a cookie by name.
 * 
 * Decodes the cookie name and searches for it in the document.cookie string.
...
/**
 * Fetches boards common code.
 *
 * Declares a variable to hold selected non-text blocks. This appears to be an 
 * implementation detail within a larger function.
 */
...
/**
* Floats the comments board UI element.
*
 ...
 *
 * Imports wp.i18n to enable translations.
 */
