 ...
 * 
 * Executes when the DOM is ready. Use this to initialize
 * code that depends on the DOM being loaded.
 */
jQuery(function ($) {
    /**
     * Document ready handler.
    ...
    $(document).ready(function () {
        ...
        /**
         * Handler for when the user clicks the "Deactivate" link in the plugin.
         * Checks if the "snooze_free_deactivate_popup" cookie is set, which indicates
         * the user has chosen to snooze the deactivation popup.
        */
        ...
        /**
         * Removes the cf_visible class from the cf_plugin_deacmodal element to hide the modal.
         */
        ...
        /**
         * Handler for when the user checks/unchecks the deactivate plugin checkbox.
         * Adds/removes the .btn-active class on the primary button to enable/disable it.
         */
        ...
        /**
         * Handler for when the user clicks the primary button in the modal footer. 
