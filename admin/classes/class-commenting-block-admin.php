...
class Commenting_block_Admin extends Commenting_block_Functions {
	...
	/**
	 * Get the current post ID from the POST data.
	 *
	...
	/**
	 * Registers the post meta field to store auto-draft IDs.
	 *
	 * This allows tracking the auto-draft post IDs associated with a given
	 * published post, for use in managing auto-draft cleanup.
	 */
